...
* **Front-end:** For our front end, we used WebStorm, Replit, Glitch and CodeCollab to code our HTML, CSS and JS.

* **Back-end:** For our back-end, we used Node.js and jQuery. 

* **Database:** For our database, we used Google Firebase, which includes Authentication feature. 
